...
!(function (t, e) {
    ...
    if (p) {
      ...
      x === S(i) &&
        ...
        (l !== a && ((l !== s && l !== o) || c !== u)) ||
          ((T = r),
          (b -=
            (m && x === O && O.visualViewport ? O.visualViewport.width : x[L]) -
            n.width),
          (b *= f ? 1 : -1));
    }
    var $,
      D = Object.assign({ position: d }, p && et),
      I =
        !0 === g
          ? (function (t, e) {
              var i = t.x,
  ...
  function bt(t, e) {
    ...
    var i = e,
        ...
        var s =
            "clippingParents" === e
              ? (function (t) {
                  var e = pt(K(t)),
                    i =
                      ["absolute", "fixed"].indexOf(B(t).position) >= 0 && $(t)
                        ? Q(t)
                        : t;
                  return L(i)
                    ? e.filter(function (t) {
      ...
      N = _t({ reference: I, element: x, placement: a }),
            ...
            var M,
              ...
              at = rt
                ? "y" === C
                  ...
                  : rt.clientLeft || 0
                : 0,
              lt = null != (M = null == D ? void 0 : D[C]) ? M : 0,
              ct = W + ot - lt,
  ...
  var Dt = $t(),
    It = $t({ defaultModifiers: [ot, Ct, nt, I] }),
  ...
  class qe extends we {
    ...
    _handleSwipe() {
      ...
      (this._deltaX = 0),
        e && Jt(e > 0 ? this._config.rightCallback : this._config.leftCallback);
    }
    _initEvents() {
      this._supportPointerEvents
  ...
  class Dn extends Ae {
    ...
    show(t) {
      this._isShown ||
        ...
        me.trigger(this._element, yn, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              me.trigger(this._element, wn, { relatedTarget: t });
          },
          this._dialog,
          this._isAnimated()
        );
  ...
  class Yn extends Ae {
    ...
    show(t) {
      this._isShown ||
        me.trigger(this._element, qn, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        this._backdrop.show(),
    ...
    _addEventListeners() {
      me.on(this._element, Un, (t) => {
        "Escape" === t.key &&
          (this._config.keyboard ? this.hide() : me.trigger(this._element, Bn));
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  class ms extends Ae {
    ...
    _createTipElement(t) {
      ...
      return (
        e.setAttribute("id", i), this._isAnimated() && e.classList.add(rs), e
      );
    }
    setContent(t) {
      (this._newContent = t),
  ...
  class Ds extends Ae {
    ...
    _process(t) {
      this._activeTarget !== t &&
        ...
        me.trigger(this._element, Es, { relatedTarget: t }));
    }
    _activateParents(t) {
  ...
  class eo extends Ae {
    ...
    show() {
      ...
      me.trigger(t, js, { relatedTarget: e }).defaultPrevented ||
